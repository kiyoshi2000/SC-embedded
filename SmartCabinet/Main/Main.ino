...
void loop() {
  ...
  //Recebimento dos dados do firebase
      ...
      do{
       ...
       if(Firebase.getBool("Auxiliary/Acess_Request/Atualizador") == true){
  ...
  //Envio de dados Firebase  
    ...
    Firebase.setString(String(Endereco + "/Gif"), LINK);
              ...
              FirebaseJson content;
              content.set("Horario", Horario);
              content.set("Medicamento", Firebase.getString("Auxiliary/Acess_Request/Medicamento"));
...
>>>>>>> 4e67034109261399137d42b0d6f57bf7c7279c30

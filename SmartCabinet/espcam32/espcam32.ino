...
void loop() {
      ...
      do{
       ...
       if(gav_open_1 || gav_open_2){  //Arombamento
            ...
            if (Firebase.ready() && !taskCompleted){
              ...
              Firebase.pushInt(Endereco_erro, "Horario");
              Firebase.setInt(String(Endereco_erro + "/Horario"), Horario);
  ...
  //Envio de dados Firebase  
    ...
    Firebase.pushInt(Endereco, "Horario");
    Firebase.setInt(String(Endereco + "/Horario"), Horario);
